...
function add_message(msg) {
    ...
    // let dn = " <font class='dname'> @" + msg["user_from"] + "</font><br><br>";
    let dn = " <font class='dname'><img src='static/avat.png' width='20' style='float:left;'></font>";
    let di = "<div class='dat'>" + msg["user_from"] + "</div>";
    let ds = "<div class='data'>" + msg["msg_txt"] + "</div>";
    let n_msg = ts + dn + di + ds;
    c.innerHTML = n_msg;
